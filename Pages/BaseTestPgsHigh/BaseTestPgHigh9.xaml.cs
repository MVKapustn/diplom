...
{
    public partial class BaseTestPgHigh9 : Page
    {
        public BaseTestPgHigh9()
        {
            InitializeComponent();
        ...
        private void Continue_Click(object sender, RoutedEventArgs e)
        {
            ...
            BaseTestHelper.SaveAnswer(PagesHelper.SkillLevel, 8, trueRB1.IsChecked.Value);
            PagesHelper.GetTo("BaseTestPgsHigh/BaseTestPgHigh10");
        }
    }
}
